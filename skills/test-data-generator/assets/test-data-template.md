...
| 场景组 | TC数量 | 重点 |
| --- | --- | --- |
| 场景组1：{{SCENE_GROUP_1}} | {{SCENE_GROUP_1_CASE_COUNT}} | {{SCENE_GROUP_1_FOCUS}} |
| 场景组2：{{SCENE_GROUP_2}} | {{SCENE_GROUP_2_CASE_COUNT}} | {{SCENE_GROUP_2_FOCUS}} |

## 场景组1：{{SCENE_GROUP_1}}

> 本组目标：{{SCENE_GROUP_1_GOAL}}

| 编号 | 测试功能点 | 数据重点 |
| --- | --- | --- |
| {{CASE_ID}} | {{CASE_TITLE}} | {{CASE_DATA_FOCUS}} |
...
> 本组目标：{{SCENE_GROUP_2_GOAL}}

| 编号 | 测试功能点 | 数据重点 |
| --- | --- | --- |
| {{CASE_ID_2}} | {{CASE_TITLE_2}} | {{CASE_DATA_FOCUS_2}} |
